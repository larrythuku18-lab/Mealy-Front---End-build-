/**
 * SvgFoodIllustration – Generates a food-themed SVG illustration based on
 * the meal's name and description. Falls back to a generic plate when the
 * food type can't be determined.
 *
 * Used as the fallback inside FoodIllustration when there's no real photo
 * (no Pexels API key configured, or the fetch failed) — a hand-drawn scene
 * reads much better than a plain colored letter.
 *
...
export default function SvgFoodIllustration({ name, description, className, style }) {
